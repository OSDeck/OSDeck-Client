...
*/
	...
	*/
	...
	//
	#define __PRGMTAG_	
#elif defined(__arm__) && !defined(ESP8266) && !defined(ESP32) && !defined(___TEENSYES) && !defined(SPARK) && !defined(STM32F2XX) && !defined(STM32F10X_MD) && !defined(STM32_SERIES_F1) && !defined(STM32_SERIES_F2)
/* 
--------------------------------------------------------------
			ARM generic
	Mistery....
