...
class Display {
  ...
  public:
    ...
    void drawTextAutoCenter(int x, int y, int size, char* text, int color);
    ...
    void drawButtonWithText(int x, int y, int with, int height ,int textSize,int color,int secondaryColor,int textColor, char* text, bool pressed = false);
    void drawButtonWithImage(int x, int y, int size ,int color, const uint32_t* imageData, bool pressed);
    void drawButtonCircle(int x, int y, int radius, int color,int secondaryColor, bool pressed);
    void drawButtonCircleWithText(int x, int y, int radius ,int textSize,int color,int secondaryColor,int textColor, char* text, bool pressed);
